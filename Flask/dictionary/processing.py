...
with open("./dict/sentiword_info_final_cleaned.json", "r", encoding="utf-8") as f:
...
p_threshold_sa = 0 # small dataset polarity 분자 가중치
p_threshold_sb = 4 # small dataset polarity 분모 가중치
