...
public class AuthController {
    ...
    public String index(Model model, HttpSession session) {
        ...
        // index.html으로 작성 시 새로고침을 하게 되면 오류 발생하여 index로 작성
        return "index";
    }
    ...
    public String newUser(@ModelAttribute @Valid RegisterRequestDto requestDto, BindingResult bindingResult, Model model) {
