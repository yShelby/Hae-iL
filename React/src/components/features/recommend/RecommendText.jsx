function RecommendText({emotion}){
    ...
    const List = [
        ...
        { "emotion": "만족/평안", "text": "마음이 편안해지는 잔잔한 이야기를 담았어요." },
        { "emotion": "만족/평안", "text": "평온한 기분을 유지해줄 따뜻한 영화입니다." },
        { "emotion": "만족/평안", "text": "조용한 하루에 잘 어울리는 감성적인 작품이에요." },
        { "emotion": "만족/평안", "text": "잔잔한 위로와 소소한 행복이 담긴 영화예요." },
        { "emotion": "만족/평안", "text": "마음을 안정시켜주는 고요한 이야기입니다." },
        { "emotion": "만족/평안", "text": "편안함 속에서 삶을 되돌아보게 해주는 영화예요." },
        ...
        { "emotion": "중립/기타", "text": "특별하지 않아도 충분히 재미있는" },
        { "emotion": "중립/기타", "text": "평범한 일상 속 작은 쉼표 같은" },
        { "emotion": "중립/기타", "text": "부담 없이 편안하게 마음을 열 수 있는 작품" },
        { "emotion": "중립/기타", "text": "크게 웃거나 울진 않아도, 마음이 따뜻해지는 순간들을 위한" },
        { "emotion": "중립/기타", "text": "가만히 있어도 좋고, 조용히 생각에 잠기게 하는" }
    ]
